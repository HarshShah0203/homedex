...
<div class="setup-shell" data-theme={theme} data-component-id="onboarding-read-contract">
  <header class="setup-top">
    <a class="brand" href="/" aria-label="Homedex setup"><span class="brand-mark" aria-hidden="true">H</span><span><strong>homedex</strong><small>Initial inventory</small></span></a>
  ...
  {#if adminRequired}
    <main class="setup-page admin-setup">
      <header class="setup-heading"><div class="kicker">ADMIN · LOCAL CREDENTIAL</div><h1>Secure this local address book.</h1><p>One administrator password protects the index. No recovery email or cloud account is created.</p></header>
  ...
  {:else}
    <main class="setup-page">
      <header class="setup-heading"><div class="kicker">FIRST SOURCE · {scanRunID ? `SCAN ${String(scanRunID).padStart(4, '0')}` : 'NOT YET SCANNED'}</div><h1>See exactly what Homedex reads.</h1><p>The source contract remains beside the live first-scan receipt, so discovery never outruns consent.</p></header>
