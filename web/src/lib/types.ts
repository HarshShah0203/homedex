...
export type Host = { id: number; name: string; kind: string; address: string; os: string; arch: string; state: string; services?: number; ports?: number; last_seen?: string; aliases?: string[]; reported_last_seen?: string | null; power_state?: string; parent_id?: number | null; parent?: string };
