...
-- and reported_last_seen, which exist by now.
...
INSERT INTO hosts_v10 (id, connector_id, natural_key, name, kind, address, os, arch, parent_host_id, notes, state, first_seen, last_seen, created_at, updated_at, aliases, reported_last_seen)
  SELECT id, connector_id, natural_key, name, kind, address, os, arch, parent_host_id, notes, state, first_seen, last_seen, created_at, updated_at, aliases, reported_last_seen FROM hosts;
DROP TABLE hosts;
ALTER TABLE hosts_v10 RENAME TO hosts;
